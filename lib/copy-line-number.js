...
export default {
  ...
  copy() {
    ...
    atom.clipboard.write(formatByObj(atom.config.get('copy-line-number.format'), {"1":curentFileName,"2":rowNum}));
    atom.notifications.addInfo("Copied: " + formatByObj(atom.config.get('copy-line-number.format'), {"1":curentFileName,"2":rowNum}));
  }
